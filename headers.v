...
`timescale 1ns/1ns
`define CellSize 34 //should be equal to KeyField + SigField + CountField. 34 for ExpA. 37 for ExpB. 40 for ExpC
`define KeyField 14 //14 for ExpA and 17 for ExpB. 20 for ExpC
`define SigField 4
`define CountField 16

`define IBFSize 100 //for ExpA, this should be 40, 60, 80, 100. For ExpB, this should be 10000, 15000, 20000, 25000
//for ExpC, 1K, 1.5K, 2K, 2.5K
`define IndexSize 7 //for ExpA, this should be 6, 6, 7, and 7. For ExpB, this should be 14, 14, 15, and 15.
...
`define SetSize  10000 //10000 for ExpA and 100000 for ExpB. 1000000 for ExpC
`define Set2Size 10020 //10020 for ExpA and 100000 for ExpB.  1000000 for ExpC
`define Common 9990 //9990 for ExpA and 95000 for ExpB. 999500 for ExpC
`define S1Distinct 10 //SetSize - Common, 10 for ExpA and 5000 for ExpB. 500 for ExpC
`define S2Distinct 30 //Set2Size - Common, 30 for ExpA and 5000 for ExpB.  500 for ExpC
`define SetLen 14 //14 for ExpA and 17 for ExpB. 20 for ExpC
`define DecodeMax 100 //for ExpA, this should 100. For ExpB, this should be 13000. For ExpC, 2000
